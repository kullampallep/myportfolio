  ...
  return (
    <Container>
      ...
      <Paragraph className="max-w-xl mt-4">
        I&apos;m a I am a fourth year student at the University of Virginia, graduating in December of 2025, pursuing a Bachelor of Science in Computer Science through the School of Engineering and a minor in Business through the McIntire School of Commerce. 
